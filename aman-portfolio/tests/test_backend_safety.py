...
class PromptAndEndpointSafetyTests(unittest.TestCase):
    ...
    def test_health_exposes_safe_configuration_and_index_metadata(self):
        ...
        self.assertNotIn("generation_model", payload["configuration"])
        self.assertNotIn("embedding_model", payload["configuration"])
        self.assertNotIn("error", payload["knowledge"])
        self.assertNotIn("error", payload["index"])
